...
class ApuestaDAO: # Clase ApuestaDAO para manejar la base de datos de apuesta
    ...
    SELECCIONAR_APUESTA = 'SELECT * FROM apuesta ORDER BY id_apuesta'   # Seleccionar todas las apuestas ordenados por id
    INSERTAR_APUESTA = '''INSERT INTO apuesta(id_persona, fecha, cantidad_apostada, cuota, 
    ...
    ACTUALIZAR_APUESTA = '''UPDATE apuesta 
    ...
    ELIMINAR_APUESTA = 'DELETE FROM apuesta WHERE id_apuesta=%s'  # Eliminar una apuesta existente por id
    ...
    def seleccionar_apuesta(cls):#recibimos el parametro cls que hace referencia a la clase apuestasDAO
        ...
        try:
            ...
            cursor.execute(cls.SELECCIONAR_APUESTA)#Ejecutar la consulta de selección llamando a la constante SELECCIONAR de la clase
    ...
    def insertar_apuesta(cls, apuesta, quien_apuesta):
        ...
        try:
            ...
            cursor.execute(cls.INSERTAR_APUESTA, valores)
    ...
    def actualizar_apuesta(cls, apuesta):
        ...
        try:
            ...
            cursor.execute(cls.ACTUALIZAR_APUESTA, valores)
    ...
    def eliminar_apuesta(cls, apuesta):#recibimos el parametro cls que hace referencia a la clase apuestaDAO
        ...
        try:
            ...
            cursor.execute(cls.ELIMINAR_APUESTA, valores) # Ejecutar la consulta de actualización llamando a la
