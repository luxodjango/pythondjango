...
# Un bucle for también puede tener una cláusula else. 
# La cláusula else se ejecutará cuando el iterador emita una excepción 
# debido a que no quedan más elementos.

for i in ["azu1", "rojo", "verde"]:
    print(i)
else:
